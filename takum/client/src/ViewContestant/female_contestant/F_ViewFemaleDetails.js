...
const FemaleDetails = ({props,setPage}) => { 
  ...
  const vote = () => {
    ...
    return(<>
                ...
                <Card style={{ width: '70vw',height:'150vh' }} variant="top" className='card shadow-sm m-3 p-2 rounded'>
                        <Card.Img style={{ objectFit: 'fill', marginTop: '0%' }} className='img' src={`https://takum.fly.dev/${image}`}/>
                        <Card.Body>
